...
internal class ArticleRepository : IArticleRepository
{
    ...
    {
        var url = $"api/articles?pagination[page]={page}&pagination[pageSize]={pageSize}&populate[blocks][populate]=*&populate[author][populate]=*&populate[cover][populate]=*&populate[category][populate]=*";
