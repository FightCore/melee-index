  import { afterNextRender, AfterViewInit, Component, OnChanges, OnInit, SimpleChanges } from '@angular/core';
...
export class AppComponent implements AfterViewInit {
  ...
  ngAfterViewInit(): void {
    this.store.select(userFeature.selectUser).pipe(tap(console.log)).subscribe(user => {
      this.user = user
